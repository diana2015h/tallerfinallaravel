...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-06-2021 a las 04:12:29
...
(11, 'yen', 'un yen equivale a 32.94 pesos', 'yes', 'jpy', '¥', '2.00', '4.00', '2.00', NULL, NULL),
(12, 'euro', 'un euro equivale a 4389 pesos', 'yes', 'EUR', '€', '2.00', '4.00', '2.00', NULL, NULL);
...
(3, '2021_06_04_235717_create_table_cb_currency_migration', 1);
...
--
ALTER TABLE `cb_currency`
  MODIFY `idcurrency` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
